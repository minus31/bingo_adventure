...
function RankingView({ state, currentTeam }: { state: GameState; currentTeam: TeamId }) {
  ...
  return <section><div className="mb-5 rounded-[24px] bg-gradient-to-br from-[#ff5c35] to-[#ff815f] p-5 text-white shadow-lg"><Trophy className="mb-4 size-8" /><h1 className="text-2xl font-black tracking-tight">최종 순위</h1><p className="mt-1 text-sm font-medium text-white/70">관리자가 확정한 칸과 완성 빙고 기준이에요.</p></div>
